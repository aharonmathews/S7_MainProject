...
const MessageList: React.FC<Props> = ({ messages }) => {
  ...
  const methodSubtitle =
    messages.curation_method === "improved_hybrid_3stage"
      ? "BM25 + Semantic + Cross-Encoder"
      : messages.curation_method === "advanced_hybrid_5stage"
        ? "BM25 + Cross-Encoder + Semantic + Engagement + Sentiment"
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto space-y-8 animate-fade-in">
      ...
      {stats &&
        ["hybrid", "improved_hybrid_3stage", "advanced_hybrid_5stage"].includes(
          messages.curation_method || "",
        ) && (
